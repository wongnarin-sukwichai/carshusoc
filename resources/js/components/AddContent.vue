<template>
    <div class="bg-white p-8 rounded-2xl md:ml-8">
        ...
        <div class="grid grid-cols-3 gap-4">
            <!-- Layout 1 -->
            <div
                class="border-2 border-dashed rounded-xl p-48 cursor-pointer hover:border-gray-300 flex flex-col items-center justify-center text-center"
            >
                <box-icon
                    name="plus"
                    size="lg"
