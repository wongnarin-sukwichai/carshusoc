...
<body style="font-family: Popins, sans-serif; background-color:#f8f9fa; padding:20px;">
    ...
    <div
        ...
        <!-- ข้อความต้อนรับ -->
        <h2 style="text-align:center; color:#333; margin-top:0%; font-weight: bold;">ได้รับข้อมูลการชำระเงิน</h2>
        <p style="text-align:left; font-size:15px; color:#555;">
            เรื่อง แจ้งการชำระเงิน
        </p>
        ...
        <p style="text-indent: 2em; text-left:center; font-size:15px; color:#555;">
         ...
         <p style="text-indent: 2em; text-left:center; font-size:15px; color:#555;">
            ขอเรียนให้ทราบว่า ทางเราได้รับข้อมูลการชำระเงินจากท่านแล้ว ในการนี้ จะดำเนินการตรวจสอบ พร้อมแจ้งผลให้ท่านทราบในลำดับต่อไป 
        </p>
        <p style="text-left:center; font-size:15px; color:#555;">
